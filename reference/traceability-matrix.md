...
| `reference/reference-project.md` | Reference Zone | convention | Core v1.1 §8.1–8.3, P13, R10–R12; skeleton | The EKA Reference Project guide: purpose (Engineering Knowledge in practice, not software architecture complexity), Feather overview, repository tree, Engineering Domain map, relationship walkthrough, CLI demonstration scenarios, screenshot checklist, integration notes. |
| `reference/project/` | Reference Zone | convention + artifacts | Core v1.1 §8.1–8.3, P13, P6, P7; R10–R12 | The EKA Reference Project ("Feather"): the complete `eka init` skeleton tree (convention copies) plus 37 populated artifacts across all five Engineering Domains — the working proof of the standard. Demonstrates: every token family with its owned State Vector (R4), dimension == folder (R6), change-log consistency (R7), projections (R8), R10 satisfied for every non-Discovery artifact (0 warnings), R12 honored (no cross-stratum supersession), P13 exercised via export/import round-trip. |
