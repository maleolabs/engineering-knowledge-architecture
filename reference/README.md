...
| [`runtime-architecture.md`](runtime-architecture.md) | Active | Knowledge Runtime Architecture (v0.2.0): EKA Workspace + canonical store + Knowledge Snapshots + synchronization protocol; Authoring · Compiler · CKO · Presentation pipeline; Runtime Kernel (services, not storage); Git/EKA/Atrium separation; CLI behavior review; future roadmap; known limitations. Convention document (ADR-009/ADR-010/ADR-011/ADR-012/ADR-013/ADR-014/ADR-015 summarized). |
| [`runtime-api.md`](runtime-api.md) | Active | The Runtime Kernel interfaces (v0.2.0): the internal Runtime API (Workspace, Knowledge, Resolver, Relations, Timeline, Snapshot, Integrity) + the Authoring API (`runtime.Authoring`: Validate/Compile/Sync) — service × operation contracts, determinism and scan-based trade-offs, storage isolation rules, package organization, future integrations. Convention document (ADR-014). |
...
| [`adr-summary.md`](adr-summary.md) | Active | Index of the 15 Implementation ADRs (zone `decisions/`). |
...
| [`decisions/`](decisions/) | Active | 15 Implementation ADRs (serialization architecture decisions ADR-001…008 + Knowledge Runtime ADR-009…015). |
