...
| [`runtime-architecture.md`](runtime-architecture.md) | Active | Knowledge Runtime Architecture (v0.2.0): EKA Workspace + canonical store + Knowledge Snapshots + synchronization protocol; Authoring · Compiler · CKO · Presentation pipeline; Git/EKA/Atrium separation; CLI behavior review; future roadmap; known limitations. Convention document (ADR-009/ADR-010/ADR-011/ADR-012/ADR-013 summarized). |
...
| [`adr-summary.md`](adr-summary.md) | Active | Index of the 13 Implementation ADRs (zone `decisions/`). |
...
| [`decisions/`](decisions/) | Active | 13 Implementation ADRs (serialization architecture decisions ADR-001…008 + Knowledge Runtime ADR-009…013). |
