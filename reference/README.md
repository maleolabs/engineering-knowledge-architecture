...
| [`adr-summary.md`](adr-summary.md) | Active | Index of the 14 Implementation ADRs (zone `decisions/`). |
...
| [`decisions/`](decisions/) | Active | 14 Implementation ADRs (serialization architecture decisions ADR-001…008 + Knowledge Runtime ADR-009…014). |
