...
// skeleton/docs/exchange/validation.md (Rules R1-R9) for the
// Engineering Knowledge Architecture (EKA) v1.0 serialization.
//
...
// and applies the nine conformance rules. The result is a deterministic,
